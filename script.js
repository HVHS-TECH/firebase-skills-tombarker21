  ...
  firebase.database().ref('/').set(
    {
      ...
      game2: {
        users: {
          wilkin: 3.141592635897932384626433832795028841971693993751058209749445923078164062862089986280348253421170679,
          aaron: 6,
          MBS: 67,
          yuvi: 4,
...
function changeAge() {
  firebase.database().ref('/game1/users/mrbob/').set(7);
}

function fb_readHighScores() {
  console.log("Reading High Scores");
  firebase.database().ref('/game1').once('value', displayRead, fb_error)
}
